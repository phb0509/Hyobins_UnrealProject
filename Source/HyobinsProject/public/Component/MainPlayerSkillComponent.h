...
public:
	static const FName NormalAttackName;
	static const FName NormalStrikeAttackName;
	static const FName Dodge_NonTargeting;
	static const FName Dodge_Targeting;
